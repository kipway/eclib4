...
\update 
  2024.2.1 work witout ec_alloctor
...
namespace ec
{
	...
	{
	public:
		udplog(int nlev = CLOG_DEFAULT_MSG) : _level(nlev), _socket(INVALID_SOCKET), _cabin(_scabin, sizeof(_scabin))
		{
